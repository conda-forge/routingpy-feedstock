...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/routingpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11857&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/routingpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `routingpy` can be installed with:

```
conda install routingpy
```

It is possible to list all of the versions of `routingpy` available on your platform with:
